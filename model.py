...
class DCGAN:
    ...
    def generator(self, inputs, training=False):
        ...
        with tf.variable_scope('generator', reuse=tf.AUTO_REUSE):
            ...
            #reshape_out = norm_layer(input_x=reshape_out, is_training=is_train)
    ...
    def discriminator(self, inputs, training=False):
        ...
        with tf.name_scope('d'), tf.variable_scope('discriminator', reuse=tf.AUTO_REUSE):
            # conv layer 1
            ...
            # conv layer 4
            outputs = tf.layers.conv2d(conv_3, self.d_dim[4], [5, 5], strides=(2, 2), padding='SAME')
